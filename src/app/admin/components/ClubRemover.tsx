...
function ClubRemovalBox({ club, onDelete }: { club: Club; onDelete: (club: Club) => void }) {
    ...
    return (
        <div className="bg-[var(--mid)] border-1 border-[var(--border)] rounded-2xl flex flex-col justify-center m-2 w-[80%] md:w-[25vw] max-w-[280px] shadow-xl/30">
            <div>
...
// Modal Integration Component
    export function ClubRemoverModal() {
      ...
      "
                ...
                modalContainerClass="w-[80vw] max-h-[90vh] overflow-y-auto rounded-xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[var(--bars)] border-1 border-[var(--fssgold)] shadow-2xl p-6 text-gray"
            />
        );
    }
