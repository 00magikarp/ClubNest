...
export function SelectionButtonRow({ initialState, passToPageAction }: SelectionButtonRowProps) {
  ...
  return (
    <div className="flex flex-wrap justify-between gap-2 w-[90dvw] mx-auto pb-2">
      {TYPES.map((type: string, idx: number) => {
        ...
        const selectedClasses = "bg-gradient-to-r from-amber-500 to-[var(--fssgold)] border-amber-400 shadow-amber-500/25"
        const unselectedClasses = "bg-gray-100 dark:bg-gray-800/80 border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/80 hover:border-gray-300 dark:hover:border-gray-600"
