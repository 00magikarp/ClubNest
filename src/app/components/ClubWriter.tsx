...
export function ClubWriter() {
    ...
    return (
        <ModalButton buttonClass=" p-2 flex items-center justify-center m-3 w-[40vw] h-[60px] text-xl !text-[var(--mid)] rounded-md select-text
      ...
      border-2 border-[var(--fssgold)] shadow-2xl p-4 text-gray"
                     modalBody={<div
                         ...
                         <h2 className="text-xl !text-[var(--text-color)] mb-10 overflow-auto">Club Writer</h2>
                         ...
                         >
                             <Stack spacing={2}>
                                 <TextFieldElement sx={textFieldStyling} name="name" label="Name" required/>
                                 ...
                                 <TextFieldElement sx={textFieldStyling} name="sponsors_contact" label="Sponsors Contacts (seperate by |)"
                                                   required/>
                                 <TextFieldElement sx={textFieldStyling} name="student_leads_name" label="Student Lead Names (seperate by |)"
                                                   required/>
