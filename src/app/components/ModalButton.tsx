  ...
  return (
    <div>
      ...
      <Modal className={ modalClass || "" } open={open} onClose={handleClose} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
        <div className="rounded-xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] bg-[var(--bars)] border-2 border-[var(--fssgold)] shadow-2xl p-4 text-gray">
