export function NoClubsFound() {
  ...
  return (
    <div className="grid h-56 grid-cols-1 content-center gap-2">
      ...
      <button
        className="items-center content-center justify-center bg-transparent hover:bg-[var(--mid)] text-[var(--foreground)] font-semibold  py-2 px-4 border border-[var(--fssgold)] rounded"
